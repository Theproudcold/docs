    ...
    nav: [
      { text: "首页", link: "/" },
      {
        ...
        items: [
          {
            text: "uniapp",
            activeMatch: "前端/uniapp",
            link: "前端/uniapp/uniapp常见项目问题",
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            activeMatch: "后端/Springboot/springboot常见项目问题",
            link: "后端/Springboot/springboot常见项目问题",
          },
          {
            text: "项目部署服务器流程",
            activeMatch: "后端/Springboot/项目部署服务器流程",
            link: "后端/Springboot/项目部署服务器流程",
          },
          {
            text: "项目打包部署流程",
            activeMatch: "后端/Springboot/项目打包部署流程",
      ...
      items: [
        {
          text: "uniapp",
          base: "/前端/uniapp",
          items: [{ text: "uniapp常见项目问题", link: "/uniapp常见项目问题" }],
        },
      ],
    },
  ];
