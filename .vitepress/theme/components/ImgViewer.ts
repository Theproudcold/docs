...
// 查找图像之前最近的标题
const findNearestHeading = (imgElement: HTMLImageElement | HTMLElement | null) => {
  // 获取 img 元素的父节点
...
export const bindFancybox = () => {
  nextTick(async () => {
    ...
    const imgs = document.querySelectorAll('.vp-doc img:not([src^="https://img.shields.io/"]):not(.not)')
    ...
    Fancybox.bind('[data-fancybox="gallery"]', {
      Hash: false, // 禁用hash导航
      Thumbs: {
        type: 'modern', // classic 经典缩略图，modern 现代缩略图
